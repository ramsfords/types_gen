...
type Bid struct {
	...
	ServiceType string `protobuf:"bytes,25,opt,name=serviceType,proto3" json:"serviceType,omitempty" dynamodbav:"serviceType,omitempty"`
...
func (x *Bid) GetServiceType() string {
	if x != nil {
...
var file_bid_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x18, 0x19, 0x20, 0x01, 0x28, 0x09,
