...
type Business struct {
	...
	BusinessName string `protobuf:"bytes,2,opt,name=business_name,proto3" json:"business_name,omitempty"`
	...
	NeedsAddressUpdate bool `protobuf:"varint,14,opt,name=needs_address_update,json=needsAddressUpdate,proto3" json:"needs_address_update,omitempty"`
	// @gotags: dynamodbav:"needs_default_pickup_address_update"
	NeedsDefaultPickupAddressUpdate bool `protobuf:"varint,15,opt,name=needs_default_pickup_address_update,json=needsDefaultPickupAddressUpdate,proto3" json:"needs_default_pickup_address_update,omitempty"`
	// @gotags: dynamodbav:"needs_default_pickup_address_update"
	NeedsDefaultDeliveryAddressUpdate bool `protobuf:"varint,16,opt,name=needs_default_delivery_address_update,json=needsDefaultDeliveryAddressUpdate,proto3" json:"needs_default_delivery_address_update,omitempty"`
}
...
var file_business_proto_rawDesc = []byte{
	...
	0x73, 0x42, 0x62, 0x0a, 0x06, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x31, 0x42, 0x0d, 0x42, 0x75, 0x73,
	0x69, 0x6e, 0x65, 0x73, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x21, 0x67, 0x69,
