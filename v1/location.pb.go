...
type Location struct {
	...
	DeliveryLocationServices []DeliveryLocationService `protobuf:"varint,9,rep,packed,name=deliveryLocationServices,proto3,enum=v1.DeliveryLocationService" json:"deliveryLocationServices,omitempty" dynamodbav:"deliveryLocationServices,omitempty"`
	// @gotags: dynamodbav:"pickupLocationServices,omitempty"
	PickupLocationServices []PickupLocationService `protobuf:"varint,10,rep,packed,name=pickupLocationServices,proto3,enum=v1.PickupLocationService" json:"pickupLocationServices,omitempty" dynamodbav:"pickupLocationServices,omitempty"`
...
var file_location_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x1b, 0x2e,
	...
	0x20, 0x03, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x76, 0x31, 0x2e, 0x70, 0x69, 0x63, 0x6b, 0x75, 0x70,
...
var file_location_proto_goTypes = []interface{}{
	...
	(DeliveryLocationService)(0), // 5: v1.deliveryLocationService
	(PickupLocationService)(0),   // 6: v1.pickupLocationService
}
